...
void BridgeTerminalView::update(const std::string& gamestate) const {
    ...
    boost::json::object gamestateObject = ( boost::json::parse(gamestate) ).as_object();
...
void BridgeTerminalView::printToScreen(boost::json::object gamestateObject) const {
...
std::string BridgeTerminalView::getContractAndTurnInfo(boost::json::object gamestate) const {
    ...
    ss << "\n" << viewUtils::convertJsonToStr(gamestate["current_lead_hand"]) << " leads this trick\n";
...
std::string BridgeTerminalView::getNSHand(boost::json::object gamestate, const std::string& dir) const {
...
std::string BridgeTerminalView::getCardsOfSuitString(boost::json::object board, const std::string& dir, const std::string& suit) const {
...
std::vector<std::string> BridgeTerminalView::extractAllRanksOfSuit(boost::json::array& hand, const std::string& suit) const {
