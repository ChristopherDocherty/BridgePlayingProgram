...
template <typename MCTS_GAME> class MCTreeNode {
...
template <typename MCTS_GAME> MCTS_GAME MCTreeNode<MCTS_GAME>::game() const {
  return d_game;
}

template <typename MCTS_GAME> bool MCTreeNode<MCTS_GAME>::isComputer() const {
  return d_isComputer;
}
...
template <typename MCTS_GAME> int MCTreeNode<MCTS_GAME>::visitCnt() const {
  return d_visitCnt;
}

template <typename MCTS_GAME> int MCTreeNode<MCTS_GAME>::winCnt() const {
  return d_winCnt;
}
...
template <typename MCTS_GAME> void MCTreeNode<MCTS_GAME>::addWin() {
  ++d_winCnt;
  ++d_visitCnt;
}
template <typename MCTS_GAME> void MCTreeNode<MCTS_GAME>::addLoss() {
  ++d_visitCnt;
}
