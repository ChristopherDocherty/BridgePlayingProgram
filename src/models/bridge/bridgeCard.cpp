...
BridgeExpected<int> convertToValidCardSuit(std::string_view suit) {
  if (suit == "NT") {
...
BridgeExpected<BridgeCard> BridgeCard::create(std::string_view suit,
...
BridgeCard::BridgeCard(const int suit, const int rank)
